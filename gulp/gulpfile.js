...
// 入出力先指定
const srcBase = '../src';
const themeName = "assist-company"; // 環境に合わせてテーマ名を変更してください
const distBase = `../${themeName}`;
const assetsBase = `../${themeName}/assets`;
const srcPath = {
...
const browserSyncOption = {
  proxy: "http://localhost:10029", // ご自身の環境に合わせて変更してください
};
...
const watchFiles = () => {
  ...
  watch(`../${themeName}/**/*.php`, browserSyncReload);
};
